...
const PLANS = [
  {
    ...
    yearlyPrice: 278,
    maxEmployees: 10,
    features: ['Up to 10 employees', 'Payroll & CPF', 'Leave management', 'IR8A filing'],
  },
  {
    id: 'growth',
    name: 'Growth',
    ...
    maxEmployees: 30,
    badge: 'Most Popular',
    features: ['Up to 30 employees', 'All Starter features', 'Commission module', 'Excel export'],
  },
  {
    id: 'business',
    name: 'Business',
    ...
    yearlyPrice: 950,
    maxEmployees: 100,
    features: ['Up to 100 employees', 'All Growth features', 'Priority support', 'Dedicated manager'],
  },
]
...
const T = {
  en: {
    ...
    trialBanner: '30-Day Free Trial',
    trialSub: 'Completely free to start · No credit card required · Cancel anytime',
    monthly: 'Monthly',
    yearly: 'Yearly',
    save: 'Save 2mo',
    ...
    submitNote: 'A confirmation email will be sent. Your free trial starts once confirmed.',
    securityNote: 'Completely free during trial · Payment reminder 7 days before trial ends',
    successTitle: "You're all set!",
    trialStarted: '30-day free trial started',
    ...
    errUEN: 'This UEN is already registered.',
    errPassword: 'Password must be at least 6 characters.',
    errMatch: 'Passwords do not match.',
    errPlan: 'Please select a plan to continue.',
  },
  zh: {
    title: 'HR 管理系統',
    backToLogin: '返回登入',
    ...
    planSummary: '已選方案',
    submitNote: '提交後將發送確認郵件，點擊確認後試用期立即開始。',
    securityNote: '試用期間完全免費，到期前7天才會提醒付款',
    successTitle: '註冊成功！',
    trialStarted: '30天免費試用已開始',
    noCharges: '試用期間不收取任何費用',
    checkEmail: '請查收確認郵件，點擊連結後即可登入系統。',
    goLogin: '前往登入',
    errRequired: '請填寫所有必填欄位',
    errUEN: '此 UEN 已被註冊',
    errPassword: '密碼至少 6 位',
    errMatch: '兩次密碼不一致',
    errPlan: '請選擇一個方案',
  },
  ms: {
    title: 'Sistem Pengurusan HR',
    backToLogin: 'Kembali Log Masuk',
    pageTitle: 'Mulakan Percubaan Percuma',
    pageSubtitle: '30 hari percuma · Tanpa kad kredit',
    steps: ['Pilih Pelan', 'Maklumat Syarikat', 'Akaun Admin', 'Semak & Hantar'],
    trialBanner: 'Percubaan Percuma 30 Hari',
    trialSub: 'Percuma sepenuhnya · Tanpa kad kredit · Batal bila-bila masa',
    monthly: 'Bulanan',
    yearly: 'Tahunan',
    save: 'Jimat 2bln',
    afterTrial: 'Selepas cuba',
    upTo: 'Sehingga',
    employees: 'pekerja',
    ...
    back: 'Kembali',
    submit: '🎉 Mula Percubaan Percuma',
    companyInfo: 'Maklumat Syarikat',
    adminAccount: 'Akaun Admin',
    ...
    planSummary: 'Pelan Dipilih',
    submitNote: 'E-mel pengesahan akan dihantar. Percubaan bermula setelah disahkan.',
    securityNote: 'Percuma semasa percubaan · Peringatan bayaran 7 hari sebelum tamat',
    successTitle: 'Berjaya Mendaftar!',
    trialStarted: 'Percubaan percuma 30 hari dimulakan',
    noCharges: 'Tiada caj semasa tempoh percubaan',
    checkEmail: 'Semak e-mel dan klik pautan pengesahan untuk mengaktifkan akaun.',
    goLogin: 'Pergi ke Log Masuk',
    errRequired: 'Sila isi semua medan yang diperlukan.',
    errUEN: 'UEN ini telah didaftarkan.',
    errPassword: 'Kata laluan mestilah sekurang-kurangnya 6 aksara.',
    errMatch: 'Kata laluan tidak sepadan.',
    errPlan: 'Sila pilih pelan untuk meneruskan.',
  },
}
    ...
    <div className="flex items-center justify-center mb-6">
      {steps.map((step, i) => (
        <div key={i} className="flex items-center">
          ...
          {i < steps.length - 1 && (
            <div className={`w-10 h-0.5 mx-1 mb-4 transition-colors duration-300 ${
    ...
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 16 }}>
        <div style={{
          ...
          borderRadius: 50, padding: 3, gap: 3,
        }}>
          ...
          return (
            ...
            >
              ...
              <div style={{
                ...
                border: isSelected ? '6px solid #1B3A5C' : '2px solid #CBD5E1',
                flexShrink: 0, transition: 'all 0.18s', background: '#fff',
              }} />
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: 6, marginBottom: 3 }}>
                  ...
                  <span style={{ fontSize: 12, color: '#94a3b8' }}>
                    · {t.upTo} {plan.maxEmployees} {t.employees}
                  </span>
                </div>
...
export default function RegisterPage({ onBackToLogin }) {
  const [lang, setLang] = useState('en')   // ← 預設英文，可切換
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <nav className="bg-blue-700 text-white px-4 py-4 flex justify-between items-center shadow sticky top-0 z-40">
        ...
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="bg-white text-blue-700 px-2 py-1 rounded text-xs font-medium border-0 cursor-pointer"
          >
            <option value="en">EN</option>
            <option value="zh">中文</option>
            <option value="ms">BM</option>
          </select>
          <button onClick={onBackToLogin} className="text-blue-200 text-sm hover:text-white whitespace-nowrap">
            {t.backToLogin}
          </button>
        </div>
      </nav>
      ...
      <div className="flex-1 flex items-start justify-center px-4 py-6">
        <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-lg">
          ...
          {/* Error (not shown on step 0 — handled inside PlanStep) */}
          {error && step !== 0 && (
          ...
          {step === 0 && (
            <PlanStep
              selected={selectedPlan} billing={billing}
              onSelect={setSelectedPlan} onBilling={setBilling}
              t={t} error={error}
            />
          )}
            ...
            <div className="space-y-4">
              <div>
                ...
                <input value={company.name}
                  ...
                  className={inputClass} placeholder="ABC Pte. Ltd." />
              </div>
              <div>
                <label className="block text-sm text-gray-600 mb-1">{t.uen} *</label>
                <input value={company.uen}
                  onChange={e => setCompany({ ...company, uen: e.target.value })}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input type="password" value={admin.password}
                  ...
                  className={inputClass} placeholder={t.passwordMin} />
              </div>
              <div>
                <label className="block text-sm text-gray-600 mb-1">{t.confirmPassword} *</label>
                <input type="password" value={admin.confirm}
          ...
          {step === 3 && (
            <div className="space-y-3 text-sm">
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: '#3B82F6', marginTop: 2 }}>
                      {t.upTo} {currentPlan?.maxEmployees} {t.employees}
                    </div>
                  </div>
                  <div style={{ textAlign: 'right' }}>
                    ...
                    <div style={{ fontWeight: 800, fontSize: 20, color: '#1E40AF' }}>
                      ...
                      <span style={{ fontSize: 12, fontWeight: 500, color: '#60A5FA' }}>
                        /{billing === 'monthly' ? 'mo' : 'yr'}
                      </span>
                    </div>
                  </div>
                ...
                <div style={{
                  marginTop: 10, paddingTop: 10, borderTop: '1px solid #BFDBFE',
                  display: 'flex', alignItems: 'center', gap: 6,
                }}>
